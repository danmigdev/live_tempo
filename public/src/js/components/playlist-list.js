...
var PlaylistListComponent = {
  ...
  render: function () {
    ...
    // Add button bar below playlist cards
    container.innerHTML += '\
    ...
    document.getElementById('btn-home-manual').addEventListener('click', function () {
      App.showPlaylistNameModal(null);
    });
    document.getElementById('btn-home-yt').addEventListener('click', function () {
      YoutubeImportComponent.show(null);
    });
  },
